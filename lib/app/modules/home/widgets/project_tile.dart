...
class ProjectTile extends StatelessWidget {
  ...
  const ProjectTile({required this.projectModel, super.key});
...
class _ProjectName extends StatelessWidget {
  final ProjectModel projectModel;
  const _ProjectName({required this.projectModel, super.key});
...
class _ProjectProgress extends StatelessWidget {
  final ProjectModel projectModel;
  const _ProjectProgress({required this.projectModel, super.key});
